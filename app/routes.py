...
# Feedback routes
@router.post("/feedback/preview", response_model=schemas.FeedbackPreview, tags=["feedback"])
def preview_feedback(feedback: schemas.FeedbackCreate):
    return feedback

@router.post("/feedback/submit", response_model=schemas.FeedbackOut, tags=["feedback"])
...
@router.get("/feedbacks", response_model=List[schemas.FeedbackOut], tags=["feedback"])
def get_feedbacks(db: Session = Depends(get_db)):
    return db.query(models.Feedback).all()

@router.get("/feedbacks/{feedback_id}", response_model=schemas.FeedbackOut, tags=["feedback"])
...
@router.put("/feedbacks/{feedback_id}", response_model=schemas.FeedbackOut, tags=["feedback"])
...
@router.delete("/feedbacks/{feedback_id}", tags=["feedback"])
